...
.navbar .nav ul li.nav_more:hover .icon_list{
	transform: rotate(180deg);
}
.navbar .nav ul li.nav_more .nav_dropdown {
	position: absolute;
	top:60px;
	width:100%;
	background: #1a1a1a;
...
.navbar .nav ul li.nav_more .nav_dropdown>a {
	display: block;
	line-height: 40px;
	text-align: center;
	color:#ffffff;
...
.navbar .nav ul li.nav_more .nav_dropdown>a:last-child {
	border-bottom:none;
}
.navbar .nav ul li.nav_more .nav_more:hover .nav_dropdown {
	display: block;
}
</style>
